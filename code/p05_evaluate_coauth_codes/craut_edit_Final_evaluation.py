...
class FinalModelEvaluation:
    def __init__(self, npz_file='all.npz'):
        """
        ...
        self.split_file = 'holdout_split.npz'
    ...
    def save_holdout(self, holdout_size=0.2):
        ...
        holdout_data = {}
        for table_name in ["TTER"]:# ['FTER', 'FTMR', 'DTER', 'DTMR', 'TTER', 'TTMR']:
    ...
    def evaluate_models(self, table_name, X_train, Y_train, X_holdout, Y_holdout):
        ...
        logging.info(f"CV R2: {cv_r2_mean:.15f} $\pm$ {cv_r2_std:.15f}\n")
        logging.info(f"CV MSE: {cv_mse_mean:.15f} $\pm$ {cv_mse_std:.15f}\n")
        logging.info(f"CV MAE: {cv_mae_mean:.15f} $\pm$ {cv_mae_std:.15f}\n")
        ...
        logging.info(f"Percentage within $\pm$ 0.001 RIU: {within_tolerance:.2f}%\n")
    ...
    def run_evaluation(self):
        ...
        results_list = []
        tables = ["TTER"]#['FTER', 'FTMR', 'DTER', 'DTMR', 'TTER', 'TTMR']
